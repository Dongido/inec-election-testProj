...
class PollingUnit extends \yii\db\ActiveRecord
{
    ...
    public static function tableName()
    {
        ...
        $pollUnits = PollingUnit::find()->leftJoin('announced_pu_results', 'polling_unit_uniqueid=polling_unit_id')
        ->all();

        foreach($pollUnits as $pollUnit){
            $score = $pollUnit->getPollingunitresult['party_score'];
        }
    }
